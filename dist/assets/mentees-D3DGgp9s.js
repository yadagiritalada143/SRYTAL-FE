...
import { u as b } from './styled-components.browser.esm-9s-BpxqM.js';
import { a as P } from './button-D3DmOMH8.js';
import { T as D } from './Title-T3OvY56h.js';
import { T as N } from './TextInput-DUPEWkCs.js';
import { I as X } from './IconSearch-D9mxNvB2.js';
import { S as M } from './SimpleGrid-B8ebT4MM.js';
import { C as B } from './Card-BOCM3d4L.js';
import { B as E } from './Badge-pr8cFvg5.js';
import { P as Y } from './Pagination-BaGk3Wb1.js';
...
const $ = ({ children: r, styles: t }) =>
    a.jsx(F, {
      children: a.jsx('button', {
        style: t == null ? void 0 : t.root,
        children: r
      })
    }),
  F = b.div`
...
`,
  W = ({ primaryText: r, onClick: t }) =>
    a.jsx(R, {
      children: a.jsxs('button', {
        className: 'button',
        onClick: t,
        children: [
          a.jsx('div', { className: 'bg' }),
          a.jsxs('svg', {
          ...
          a.jsxs('div', {
            ...
            children: [
              ...
              a.jsx('div', { className: 'outline' }),
              a.jsxs('div', {
                className: 'content',
                children: [
                  a.jsx('span', {
                    className: 'char state-1',
                    children: r
                      .split('')
                      .map((s, n) =>
                        a.jsx(
...
`,
  ...
  la = () => {
    const r = I(),
      { themeConfig: t, organizationConfig: s } = T(),
      [n, g] = o.useState([]),
      [v, w] = o.useState(!0),
      [p, k] = o.useState(''),
      [l, f] = o.useState(1),
    ...
    const d = n.filter(
        e =>
          e.name.toLowerCase().includes(p.toLowerCase()) ||
          e.empId.toLowerCase().includes(p.toLowerCase())
      ),
      c = 6,
      x = Math.ceil(d.length / c),
      j = d.slice((l - 1) * c, l * c),
      S = l,
      C = f;
    return a.jsxs(m, {
      gap: 24,
      px: 'md',
      style: { color: t.button.textColor, fontFamily: r.fontFamily },
      children: [
        a.jsx(m, {
          align: 'center',
          gap: 9,
          ...
          children: a.jsx(D, {
            className:
              'text-xl sm:text-2xl md:text-3xl font-extrabold underline text-center px-2 py-4',
            children: 'Mentee Tasks Flow'
          })
        }),
        a.jsx(h, {
          ...
          children: a.jsx(N, {
            ...
            value: p,
            onChange: e => {
              (k(e.currentTarget.value), f(1));
            },
            leftSection: a.jsx(X, { size: 18 }),
            w: { base: '100%', sm: 300 },
            radius: 'md',
            styles: {
              input: {
                                  ...
                                  a.jsxs(h, {
                                    ...
                                    children: [
                                      ...
                                      a.jsx(W, {
                                        ...
                                        onClick: () =>
                                          y(
                                            `${P(s.organization_name)}/dashboard/common/mentees/${e.empId}`
                                          ),
                                        children: 'Assign'
                                      })
                                    ]
                        ...
                        x > 1 &&
                          a.jsx(u, {
                            ...
                            children: a.jsx(Y, {
                              ...
                              radius: 'md',
                              styles: {
                                control: { borderColor: t.borderColor }
                              }
                            })
                          })
                      ]
