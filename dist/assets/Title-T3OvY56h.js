...
function j(e, n) {
  ...
  return b.includes(t)
    ...
    : H.includes(t)
      ? {
          fontSize: `var(--mantine-font-size-${t})`,
...
const N = { order: 1 },
  R = W((e, { order: n, size: t, lineClamp: s, textWrap: a }) => {
    const i = j(n || 1, t);
    return {
      root: {
        ...
        '--title-fz': i.fontSize,
        '--title-line-clamp': typeof s == 'number' ? s.toString() : void 0,
        '--title-text-wrap': a
      }
    };
  }),
  l = x((e, n) => {
    ...
    return [1, 2, 3, 4, 5, 6].includes(o)
      ? T.jsx(w, {
          ...
          variant: u,
          ref: n,
          mod: [{ order: o, 'data-line-clamp': typeof g == 'number' }, v],
          size: f,
          ...d
        })
      : null;
