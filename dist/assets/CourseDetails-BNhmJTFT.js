...
import { I as z } from './IconArrowLeft-DGaJMG-t.js';
import { T as k } from './Title-T3OvY56h.js';
import { B as y } from './Badge-pr8cFvg5.js';
import { D as B } from './Divider-C8nnAxUa.js';
import { C as l } from './Card-BOCM3d4L.js';
import { I } from './IconUsers-gx_wuuXq.js';
import { I as S } from './IconBook-BHRzfMqD.js';
import { I as D } from './IconClock-CuJY7wT9.js';
import { I as T } from './Image-Ck_xSqda.js';
import { I as E } from './IconTrash-BQZ6jsv8.js';
import { I as A } from './IconEdit-BA67kK5H.js';
...
const M = {
  ...
  K = () => {
    const [o] = p.useState(M),
      { themeConfig: r, isDarkTheme: c } = x(),
      { id: n } = g(),
      m = f(),
      s = j('(max-width: 768px)'),
      u = () => {
        console.log('Edit course:', n);
      },
      h = () => {
        console.log('Delete course:', n);
      };
    return e.jsx(w, {
      size: 'lg',
      py: { base: 'md', sm: 'xl' },
              ...
              e.jsxs(a, {
                ...
                children: [
                  ...
                  e.jsx(y, {
                    size: s ? 'md' : 'lg',
                    variant: 'light',
                    color: o.status === 'published' ? 'green' : 'blue',
                    mt: { base: 'xs', sm: 0 },
                    children:
                ...
                e.jsxs(t, {
                  ...
                  children: [
                    e.jsxs(a, {
                      gap: 'xs',
                      children: [
                        e.jsx(I, { size: s ? 18 : 20, color: '#228BE6' }),
                        e.jsx(i, {
                          size: s ? 'lg' : 'xl',
                          fw: 700,
                          children: o.students
                ...
                e.jsxs(t, {
                  ...
                  children: [
                    e.jsxs(a, {
                      gap: 'xs',
                      children: [
                        e.jsx(S, { size: s ? 18 : 20, color: '#228BE6' }),
                        e.jsx(i, {
                          size: s ? 'lg' : 'xl',
                          fw: 700,
                          children: o.modules
                ...
                e.jsxs(t, {
                  ...
                  children: [
                    e.jsxs(a, {
                      gap: 'xs',
                      children: [
                        e.jsx(D, { size: s ? 18 : 20, color: '#228BE6' }),
                        e.jsx(i, {
                          size: s ? 'lg' : 'xl',
                          fw: 700,
                          children: o.duration
            ...
            children: e.jsxs(t, {
              ...
              children: [
                ...
                e.jsx(b, {
                  ...
                  radius: 'md',
                  style: {
                    backgroundColor: c ? '#1a1b1e' : '#f8f9fa',
                    border: `1px solid ${r.borderColor}`
                  },
                  children: e.jsx(C, {
                    style: {
                      color: r.color,
                      fontSize: s ? '14px' : '15px',
                      lineHeight: 1.6
                    },
                    dangerouslySetInnerHTML: { __html: o.courseDescription }
                  })
                })
              ]
            })
            ...
            children: e.jsxs(a, {
              ...
              children: [
                e.jsx(d, {
                  variant: 'light',
                  color: 'red',
                  leftSection: e.jsx(E, { size: 18 }),
                  onClick: h,
                  fullWidth: s,
                  children: 'Delete Course'
                }),
                e.jsx(d, {
                  leftSection: e.jsx(A, { size: 18 }),
                  onClick: u,
                  fullWidth: s,
